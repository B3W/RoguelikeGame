...
void npc_next_pos_rand_tunnel(dungeon *d, character_t *c, pair_t next)
{
  pair_t n;
  union {
    uint32_t i;
...
void npc_next_pos_rand(dungeon *d, character_t *c, pair_t next)
{
  pair_t n;
  union {
    uint32_t i;
...
void npc_next_pos_line_of_sight(dungeon *d, character_t *c, pair_t next)
{
  pair_t dir;
...
void npc_next_pos_gradient(dungeon *d, character_t *c, pair_t next)
{
...
static void npc_next_pos_00(dungeon *d, character_t *c, pair_t next)
{
...
static void npc_next_pos_01(dungeon *d, character_t *c, pair_t next)
{
...
static void npc_next_pos_02(dungeon *d, character_t *c, pair_t next)
{
...
static void npc_next_pos_03(dungeon *d, character_t *c, pair_t next)
{
  /*     smart;     telepathic; not tunneling; not erratic */
  npc_next_pos_gradient(d, c, next);
}

static void npc_next_pos_04(dungeon *d, character_t *c, pair_t next)
{
...
static void npc_next_pos_05(dungeon *d, character_t *c, pair_t next)
{
...
static void npc_next_pos_06(dungeon *d, character_t *c, pair_t next)
{
...
static void npc_next_pos_07(dungeon *d, character_t *c, pair_t next)
{
  /*     smart;     telepathic;     tunneling; not erratic */
  npc_next_pos_gradient(d, c, next);
}

static void npc_next_pos_08(dungeon *d, character_t *c, pair_t next)
{
...
static void npc_next_pos_09(dungeon *d, character_t *c, pair_t next)
{
...
static void npc_next_pos_0a(dungeon *d, character_t *c, pair_t next)
{
...
static void npc_next_pos_0b(dungeon *d, character_t *c, pair_t next)
{
...
static void npc_next_pos_0c(dungeon *d, character_t *c, pair_t next)
{
...
static void npc_next_pos_0d(dungeon *d, character_t *c, pair_t next)
{
...
static void npc_next_pos_0e(dungeon *d, character_t *c, pair_t next)
{
...
static void npc_next_pos_0f(dungeon *d, character_t *c, pair_t next)
{
...
void (*npc_move_func[])(dungeon *d, character_t *c, pair_t next) = {
